...
TEMPLATES: list[WorkingPaperTemplate] = [
    ...
    WorkingPaperTemplate(
        ...
        statement="balance_sheet",
        section="equity",
        purpose="Support opening equity and current earnings. There is no year-end close journal.",
        objective="Roll opening equity + draws + current earnings to closing equity (statement of changes in equity).",
        tie_out="Opening equity + contributions/draws + current earnings (fiscal YTD NI) = closing equity = BS total equity. Current earnings are not closed to retained earnings.",
        procedures=[
            "Prepare the equity roll (SCE): opening, draws/contributions, current earnings, closing.",
            "Agree opening equity to prior closing (cashbook: bank openings + GL 3000 + pre-FY NI).",
            "Agree current earnings to fiscal YTD net income. Do not expect a year-end close JE.",
            "Vouch contributions and owner draws to bank evidence / resolutions.",
            "Tie closing equity on the SCE to Balance Sheet total equity.",
        ],
        evidence=[
            "Statement of changes in equity",
            "P&L / current earnings tie-out",
