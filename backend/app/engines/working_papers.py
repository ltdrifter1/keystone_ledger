...
TEMPLATES: list[WorkingPaperTemplate] = [
    ...
    WorkingPaperTemplate(
        ...
        statement="balance_sheet",
        section="liability",
        purpose="Prove intercompany balances eliminate / match across entities.",
        ...
        procedures=[
            ...
            "Agree IC lines to Balance Sheet and consolidation eliminations (if applicable).",
        ],
        evidence=[
        ...
        line_codes=["BS_IC", "2500", "6000"],
        account_codes=["2500", "6000"],
        sort_order=80,
    ),
    WorkingPaperTemplate(
    ...
    WorkingPaperTemplate(
        ...
        statement="balance_sheet",
        section="liability",
        purpose="Support third-party debt balances, interest, and classification.",
        objective="Agree loan GL to lender statements; split current vs long-term.",
        tie_out="Opening + draws − principal payments ± FX = closing; accrued interest separate if needed.",
        procedures=[
            "Obtain lender statements / amortization schedules as of period end.",
            "Roll forward principal and accrued interest.",
            "Confirm rate, covenants, and collateral disclosures (memo).",
            "Classify current vs non-current portion.",
            "Agree loans payable to Balance Sheet.",
        ],
        evidence=[
            "Lender statements",
    ...
    WorkingPaperTemplate(
        ...
        line_codes=["BS_EQUITY", "BS_DRAWS", "3000", "6100"],
        account_codes=["3000", "6100"],
        sort_order=100,
    ),
    WorkingPaperTemplate(
        key="pnl_analysis",
        ...
        procedures=[
            ...
            "Confirm department / entity filters used for management vs statutory view.",
        ...
        account_codes=["4000", "4100", "5000", "5100", "5200", "5300", "5400", "5500"],
        sort_order=110,
    ),
]
...
_REQUIRED_ACCOUNTS = [
    ...
    ("1200", "Prepaid Expenses", "asset", "balance_sheet", "debit", False, False, 25),
    ("1300", "Inventory", "asset", "balance_sheet", "debit", False, False, 28),
    ("1500", "Fixed Assets", "asset", "balance_sheet", "debit", False, False, 30),
    ("2000", "Accounts Payable", "liability", "balance_sheet", "credit", False, False, 40),
    ("2100", "Accrued Liabilities", "liability", "balance_sheet", "credit", False, False, 50),
    ("2200", "Taxes Payable", "liability", "balance_sheet", "credit", False, False, 55),
    ("2300", "Loans Payable", "liability", "balance_sheet", "credit", False, False, 58),
    ("2500", "Intercompany Payable", "liability", "balance_sheet", "credit", False, True, 60),
    ("2600", "Shareholder Loan", "liability", "balance_sheet", "credit", False, False, 65),
    ("3000", "Equity / Owner Capital", "equity", "balance_sheet", "credit", False, False, 70),
    ("6100", "Owner Draw / Distribution", "equity", "balance_sheet", "debit", False, False, 170),
]
...
def ensure_working_paper_foundation(db: Session) -> dict[str, int]:
    ...
    bs_layout = [
        ...
        ("BS_PREPAID", "Prepaid Expenses", "asset", by_code["1200"].id, None, None, 1, False, False, 40),
        ("BS_INV", "Inventory", "asset", by_code["1300"].id, None, None, 1, False, False, 50),
        ("BS_FA", "Fixed Assets", "asset", by_code["1500"].id, None, None, 1, False, False, 60),
        ("BS_TOT_ASSETS", "Total Assets", "asset", None, None, "BS_CASH + BS_AR + BS_PREPAID + BS_INV + BS_FA", 0, True, True, 70),
        ...
        ("BS_ACCR", "Accrued Liabilities", "liability", by_code["2100"].id, None, None, 1, False, False, 100),
        ("BS_TAX", "Taxes Payable", "liability", by_code["2200"].id, None, None, 1, False, False, 110),
        ("BS_LOANS", "Loans Payable", "liability", by_code["2300"].id, None, None, 1, False, False, 120),
        ("BS_IC", "Intercompany", "liability", by_code["2500"].id, None, None, 1, False, False, 130),
        ("BS_SH_LOAN", "Shareholder Loan", "liability", by_code["2600"].id, None, None, 1, False, False, 140),
        (
            "BS_TOT_LIAB",
            "Total Liabilities",
            "liability",
            None,
            None,
            "BS_AP + BS_ACCR + BS_TAX + BS_LOANS + BS_IC + BS_SH_LOAN",
            0,
            True,
            True,
            150,
        ),
        ("BS_EQ_HDR", "Equity", "equity", None, None, None, 0, True, False, 160),
        ("BS_EQUITY", "Equity / Owner Capital", "equity", by_code["3000"].id, None, None, 1, False, False, 170),
        ("BS_DRAWS", "Owner Draws", "equity", by_code["6100"].id, None, None, 1, False, False, 180),
        ("BS_TOT_EQUITY", "Total Equity", "equity", None, None, "BS_EQUITY + BS_DRAWS", 0, True, True, 190),
    ]
